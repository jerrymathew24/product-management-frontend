...
const AddCategoryModel = ({ visible, onClose }) => {
    ...
    return (
        <div id='categoryModel' onClick={handleCloseCategory} className='fixed inset-0 bg-black bg-opacity-30   flex justify-center items-center'>
            <div className="bg-white p-2 rounded-lg ">
                <h1 className='p-4 text-center text-gray-600 font-medium'>Add Category</h1>
                <input placeholder='Enter Category Name' className='border border-gray-400 rounded-lg p-1 m-5' type="text" />
